    ...
    return {
      projects: [
        ...
        },
        {
          title: '创新工作室',
          subtitle: '公益，需要我们去创新',
          text: '创新工作室在协会中扮演着公益孵化器、实验室和先驱者的角色。创新工作室致力于实践新的公益想法，探索公益的新领域。目前，创新工作室下属任务魔方、直播支教、春风计划三个子项目。',
          boxes: [
            {
