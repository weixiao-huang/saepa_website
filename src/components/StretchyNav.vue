...
<style lang="scss" scoped>
  ...
  .cd-stretchy-nav ul a::after {
    ...
    opacity: .6;
    background: url(../images/strechy/cd-sprite-1.svg) no-repeat 0 0;
  }
  ...
  .cd-stretchy-nav.nav-is-visible ul a.router-link-active {
    color: $nav_hover_color;
  }
  .cd-stretchy-nav.nav-is-visible ul a.router-link-active::after {
    opacity: 1;
  }
  .cd-stretchy-nav.nav-is-visible ul a.router-link-active::before {
  ...
  .cd-stretchy-nav.add-content ul a::after {
    ...
    -o-transform: translateY(-50%) scale(0);
    transform: translateY(-50%) scale(0);
    background-image: url(../images/strechy/cd-sprite-2.svg);
  }
  ...
  .cd-stretchy-nav.edit-content .cd-nav-trigger::after {
    ...
    -o-transform: translateX(-50%) translateY(-50%);
    transform: translateX(-50%) translateY(-50%);
    background: url(../images/strechy/cd-sprite-3.svg) no-repeat 0 0;
  }
  ...
  .cd-stretchy-nav.edit-content ul a::after {
    right: 7px;
    background-image: url(../images/strechy/cd-sprite-3.svg);
  }
